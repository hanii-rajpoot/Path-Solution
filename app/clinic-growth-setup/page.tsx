...
export const metadata: Metadata = {
  title: "Clinic Growth Landing Page | Path Solution",
  description:
    "Get a premium website, landing page, and lead generation setup for your clinic. Book a free consultation with Path Solution.",
};
...
export default function ClinicGrowthSetupPage() {
  return (
